...
define(['require', 'lodash', 'jquery', 'log', 'file_browser', 'workspace/file'],
    function (require, _, $, log, FileBrowser, File) {
        var inMemoryList = [];
        var siddhiApps = [];
        var payload = {
            serverList: [],
        ...
        DeployFileDialog.prototype.render = function () {
            ...
            self.selectAllServers = function (source) {
                console.log("Laaaaa");
        ...
        DeployFileDialog.prototype.deleteServer = function (i) {
            var id = i;
            var serverContainer = $('#server-container');
            var serverListHtml = [];
        ...
        DeployFileDialog.prototype.selectAllServers = function (source) {
            var checkboxes = document.getElementsByName("server-credentials");
            for (var i = 0, n = checkboxes.length; i < n; i++) {
                checkboxes[i].checked = source.checked;
            }
