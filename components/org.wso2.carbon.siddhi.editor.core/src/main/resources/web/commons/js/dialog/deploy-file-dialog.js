            ...
            /** @lends SaveToFileDialog.prototype */
            {
                ...
                render: function () {
                    ...
                    var fileOpen = $(
                        ...
                        "<h5 class='modal-title file-dialog-title'>Servers</h5>" +
                        "<hr class='style1'>"+
                        "<div class='form-group'>" +
                        "<div class='file-dialog-form-scrollable-block'>" +
                        ...
                        "<input class='file-dialog-form-toggle' id='host' readonly>" +
                        //"<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<input class='file-dialog-form-toggle' id='port' readonly>" +
                        //"<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<input class='file-dialog-form-toggle' id='user_name' readonly>" +
                        //"<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<input class='file-dialog-form-toggle' id='password' readonly>" +
                        "<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<button id='delete' type='button' class='btn btn-primary'>Delete" +
                        "</button>" +
                        ...
                        // "<button id='addNew' type='button' class='btn btn-primary'>Add New" +
                        // "</button>" +
                        // "</div>" +
                        // "</div>" +

                        "<h5 class='modal-title file-dialog-title'>Add New Server</h5>" +
                        "<hr class='style1'>"+

                        "<div class='form-group'>" +
                        "<div class='file-dialog-form-new-sever-container'>" +
                        "<input class='file-dialog-form-toggle-left' id='new_host' placeholder='Host'>" +
                        "<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<input class='file-dialog-form-toggle-left' id='new_port' placeholder='Port'>" +
                        "<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<input class='file-dialog-form-toggle-right' id='new_user_name' placeholder='User Name'>" +
                        "<div class='file-dialog-form-new-sever-container-toggle-divider'/>" +
                        "<input class='file-dialog-form-toggle-right' id='new_password' placeholder='Password'>" +

                        "<div class='file-dialog-form-divider'>" +
                        "</div>" +
                        "<div class='file-dialog-form-btn'>" +
                        "<button id='addNew' type='button' class='btn btn-primary'>Add" +
                        "</button>" +
                        "</div>" +
                        ...
                        "<div class='form-group'>" +
                        "<div class='file-dialog-form-btn'>" +
                        "<button id='openButton' type='button' class='btn btn-primary'>deploy" +
                        "</button>" +
                        "<div class='divider'/>" +
